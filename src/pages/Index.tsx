          ...
          <div className="grid md:grid-cols-[1fr_auto] gap-8 items-center">
            <div className="animate-fade-in-up max-w-xl">
              ...
              <div className="flex flex-wrap gap-4 items-center">
                ...
                <Link to="/publish" className="text-primary-foreground/70 hover:text-primary-foreground text-sm font-medium transition-colors flex items-center gap-1.5">
              ...
              <div className="flex gap-8 mt-10 pt-8 border-t border-primary-foreground/10">
                {[
                  ...
                  <div key={stat.label}>
                    ...
                    <p className="text-primary-foreground/50 text-xs uppercase tracking-wider mt-0.5">{stat.label}</p>
                  </div>
                ))}
              </div>
            </div>

            {/* Right side: Auk mascot with decorative elements */}
            <div className="hidden md:flex flex-col items-center gap-6 animate-fade-in">
              <div className="relative">
                ...
                <div className="absolute -inset-12 rounded-full border border-primary-foreground/5" />
                <img
                  src={greatAukHero}
                  alt="The Great Auk"
                  className={`w-64 h-64 lg:w-80 lg:h-80 object-contain drop-shadow-2xl cursor-pointer hover:scale-105 transition-transform relative z-10 ${aukPlaying ? 'auk-playing' : ''}`}
                  onClick={() => toggleAukCall()}
                  title="Click to hear the Great Auk"
                />
              </div>
              <p className="text-primary-foreground/30 text-xs italic">Click the Auk ↑</p>
            </div>
          </div>
        </div>
      </section>
